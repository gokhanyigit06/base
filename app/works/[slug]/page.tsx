...
export default function ProjectDetail({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const renderMedia = (item: any) => {
        const isVideo = item.src && (item.src.includes('.mp4') || item.src.includes('.webm'));
        ...
        // Fallback or Image
        return (
            <div className={`w-full h-full bg-gray-100 flex items-center justify-center text-center relative`}>
                {item.src && (
                    <Image
                        src={item.src}
                        alt="Project Media"
        ...
        <main className="min-h-screen bg-white text-black selection:bg-brand-yellow selection:text-black">
            ...
            <section className="w-full px-6 md:px-12 pt-32 pb-8">
                <div className="relative w-full aspect-[2/1] rounded-[2rem] overflow-hidden bg-zinc-100">
                    {project.cover_image && (
                        (project.cover_image.includes('.mp4') || project.cover_image.includes('.webm')) ? (
                            <video
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 gap-x-8">
                    ...
                    <div className="lg:col-span-6 flex flex-col gap-8">
                        ...
                        <div className="text-base md:text-lg text-gray-500 font-light leading-relaxed space-y-6">
                            ...
                            {/* Additional paragraph as requested */}
                            <p>
